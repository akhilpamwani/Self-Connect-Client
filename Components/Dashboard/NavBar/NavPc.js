...
<nav className="flex z-50   bg-white text-black  flex-row justify-center   w-full shadow-lg  NavBar  shadow-blue-500      bg-inherit" >
            ...
            <Link href='/'><Image src={logo} width={150} className='list-none text-center -mt-8 items-center m-auto justify-center flex font-semibold  font-serif text-inherit text-lg'/></Link>
            </div>
